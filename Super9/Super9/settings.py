"""
Django settings for Super9 project.
...
SECRET_KEY = 'django-insecure-o&%3(&ehrlw$vmmjs--h+=j6p$vkd*xcwkudm3pfu(s&s-bcw8'
...
WSGI_APPLICATION = 'Super9.wsgi.application'
...
# Asegúrate de que la ruta base (BASE_DIR) sea correcta.
